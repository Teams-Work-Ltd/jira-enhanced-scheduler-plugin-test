...
@Component
public class TimedJobRunner3 implements JobRunner {
    private static final Logger log = LoggerFactory.getLogger(TimedJobRunner3.class);
    public static final String NAME = "timed-job-runner3";
    public static final JobRunnerKey KEY = JobRunnerKey.of(TimedJobRunner3.class.getName());

    private final SchedulerService schedulerService;
    private final TimedJob timedJob;

    public TimedJobRunner3(@ComponentImport final SchedulerService schedulerService,
    ...
    public void scheduleJob() throws SchedulerServiceException {
        ...
        log.debug("Scheduling timed job runner 3 with schedule: " + runSchedule);
