...
@Component
public class TimedJobRunner6 implements JobRunner {
    private static final Logger log = LoggerFactory.getLogger(TimedJobRunner6.class);
    public static final String NAME = "timed-job-runner6";
    public static final JobRunnerKey KEY = JobRunnerKey.of(TimedJobRunner6.class.getName());

    private final SchedulerService schedulerService;
    private final TimedJob timedJob;

    public TimedJobRunner6(@ComponentImport final SchedulerService schedulerService,
    ...
    public void scheduleJob() throws SchedulerServiceException {
        ...
        log.debug("Scheduling timed job runner 6 with schedule: " + runSchedule);
