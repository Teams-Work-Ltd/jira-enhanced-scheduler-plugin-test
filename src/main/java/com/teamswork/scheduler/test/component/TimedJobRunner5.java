...
@Component
public class TimedJobRunner5 implements JobRunner {
    private static final Logger log = LoggerFactory.getLogger(TimedJobRunner5.class);
    public static final String NAME = "timed-job-runner5";
    public static final JobRunnerKey KEY = JobRunnerKey.of(TimedJobRunner5.class.getName());

    private final SchedulerService schedulerService;
    private final TimedJob timedJob;

    public TimedJobRunner5(@ComponentImport final SchedulerService schedulerService,
    ...
    public void scheduleJob() throws SchedulerServiceException {
        ...
        log.debug("Scheduling timed job runner 5 with schedule: " + runSchedule);
