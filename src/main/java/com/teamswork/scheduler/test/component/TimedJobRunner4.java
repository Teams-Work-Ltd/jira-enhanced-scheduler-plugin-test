...
@Component
public class TimedJobRunner4 implements JobRunner {
    private static final Logger log = LoggerFactory.getLogger(TimedJobRunner4.class);
    public static final String NAME = "timed-job-runner4";
    public static final JobRunnerKey KEY = JobRunnerKey.of(TimedJobRunner4.class.getName());

    private final SchedulerService schedulerService;
    private final TimedJob timedJob;

    public TimedJobRunner4(@ComponentImport final SchedulerService schedulerService,
    ...
    public void scheduleJob() throws SchedulerServiceException {
        ...
        log.debug("Scheduling timed job runner 4 with schedule: " + runSchedule);
